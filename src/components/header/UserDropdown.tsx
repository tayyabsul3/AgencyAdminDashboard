...
export default function UserDropdown() {
  ...
  const displayName = user?.name || "Musharof";
  const displayEmail = user?.email || "randomuser@pimjo.com";
  const avatarSrc = user?.avatar || "/images/user/owner.jpg";
      ...
      <div className="relative">
        ...
        >
          ...
          <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
            ...
            <li>
              <DropdownItem
                onItemClick={() => handleComingSoon("Account Settings")}
            ...
            <li>
              <DropdownItem
                onItemClick={() => handleComingSoon("Support")}
                className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300 cursor-pointer"
              >
                <svg
                  className="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300"
