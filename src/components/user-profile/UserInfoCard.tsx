...
export default function UserInfoCard() {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (name in personalInfo.socialLinks) {
      setEditInfo(prev => ({
        ...prev,
        socialLinks: {
          ...prev.socialLinks,
    ...
    const updatedUser = {
      ...
      profile: {
        ...
        socialLinks: {
          ...
          facebook: editInfo.socialLinks.facebook,
          twitter: editInfo.socialLinks.twitter,
          linkedin: editInfo.socialLinks.linkedin,
          instagram: editInfo.socialLinks.instagram
        }
      }
    };
  ...
  // Check if all personal info fields are empty
  const isEmptyInfo = !personalInfo.firstName && 
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div>
                    ...
                    <Input 
                      type="text" 
                      name="twitter"
                      value={editInfo.socialLinks.twitter}
                      onChange={handleInputChange}
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      name="linkedin"
                      value={editInfo.socialLinks.linkedin}
                      onChange={handleInputChange}
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      name="instagram"
                      value={editInfo.socialLinks.instagram}
                      onChange={handleInputChange}
